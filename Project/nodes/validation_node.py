...
from Project.state import ProductQualityState, AgentResult
...
def validation_node(state: ProductQualityState) -> ProductQualityState:
    ...
    if not is_valid:
        ...
        error_result: AgentResult = {
            ...
            "suggestions": ["Fix validation errors before publishing the product listing."],
            "details": {},
        }
        quality_results["validation"] = error_result
